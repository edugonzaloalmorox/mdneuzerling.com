...
A macro, however, lets me move code around _before it is evaluted_. Macros start with the `@` symbol:
...
I've glossed over subjects like speed and compilation because these are areas which I'm not confident discussing. The rough idea is that Julia is _fast_, and the compiled code is often very similar to C. But a really powerful consequence of this is that _a user doesn't need to learn another language to become a contributor_.
