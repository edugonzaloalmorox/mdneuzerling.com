...
| Run tests | [`devtools::test`](https://devtools.r-lib.org/reference/test.html) | UI option: In RStudio, look for the "Test package" option below the "More" button in the "Build" tab |
